...
func HidEnumerate(vendorID uint16, productID uint16) []HidDeviceInfo {
	...
	for ; head != nil; head = head.next {
		...
		//fmt.Printf("HidEnumerate infos: %s,%s,%s\n", info.Path, info.Serial, info.Product)
	}
	//fmt.Printf("HidEnumerate :\n", infos)
	return infos
}
